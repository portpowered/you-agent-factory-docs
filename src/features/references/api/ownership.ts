 ...
 *
 * Prefer importing from `@/features/references/api` for OpenAPI API UI.
...
export const API_REFERENCE_FORBIDDEN_OWNERSHIP_ROOTS = [
  ...
  "src/features/references/harness",
] as const;
