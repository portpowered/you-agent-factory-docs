    ...
    <header className="shared-shell__header border-b bg-card px-5 py-4 md:px-6">
      <div className="shared-shell__header-row flex items-center justify-between gap-4">
        ...
        <ShellDisclosureTrigger
          className="shared-shell__menu-toggle items-center justify-center rounded-md border bg-card px-4 py-2.5 font-semibold text-card-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
