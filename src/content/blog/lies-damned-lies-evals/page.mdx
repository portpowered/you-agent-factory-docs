...
watching is covered on the
[statistical process control (SPC) graphs](/docs/concepts/statistical-process-control-graphs)
concept page. This post stays on the evaluation argument rather than restating
those references.
