...
Think of the mix as a conceptual stack rather than measured dataset percentages: early eras lean on web-scale pretraining, later eras add mid-training, preference optimization, verifiable rewards, and distillation without erasing the internet-scale foundation.
