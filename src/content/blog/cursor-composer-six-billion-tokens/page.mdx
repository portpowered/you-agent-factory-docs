...
Stable definitions for harness, bottlenecks, and compaction live on the concept pages linked below, with harness-support for which agent runtimes the factory can drive. Use those pages when you need glossary anchors; keep this post for the examination narrative.
