...
Stable definitions for harness, bottlenecks, and compaction live on the concept pages linked below. For which agent runtimes the factory can drive, see the in-prose [Harness support](/docs/documentation/harness-support) link above. Use those pages when you need glossary anchors; keep this post for the examination narrative.
