/**
 * Discoverability proof for /docs/concepts/skills (story 007).
...
const DOCS_SLUG = ["concepts", "skills"] as const;
const DOCS_ROUTE = "/docs/concepts/skills";
const DOCS_TITLE = "Skills";
...
describe("skills concept discoverability (007)", () => {
  afterEach(() => {
    cleanup();
  });
  ...
  test("default-locale messages stay factory-focused", () => {
    ...
    expect(enMessages.description).toMatch(/reusable instruction packages/i);
