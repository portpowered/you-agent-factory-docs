---
title: SentencePiece
description: A tokenizer system that learns subword pieces directly from raw text, including spaces, without requiring word splitting first.
kind: "module"
...
<Section id="math-or-compute-schema" titleKey="sections.mathOrComputeSchema.title">
  ...
  <ModuleAttentionSchemaComparison schemaIds={["sentencepiece"]} />
</Section>
