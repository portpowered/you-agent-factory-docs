...
const embed = createFactoryVariantSchemaEmbed({
  id: "classifier-type",
  pagePath: "/docs/workstations/classifier",
  overlayId: "workstation:CLASSIFIER_WORKSTATION",
  loadDefinition: () => loadWorkstationBaseSchemaEmbedModel().definition,
  loadOverlay: () =>
    createProductionWorkstationTypeOverlay("CLASSIFIER_WORKSTATION"),
});

export const CLASSIFIER_TYPE_PAGE_PATH = embed.pagePath;
export const CLASSIFIER_TYPE_OVERLAY_ID = embed.overlayId;
export const ClassifierTypeVariantSchemaEmbed = embed.Embed;
