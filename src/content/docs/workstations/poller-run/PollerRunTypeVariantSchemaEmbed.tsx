...
const embed = createFactoryVariantSchemaEmbed({
  id: "poller-run-type",
  pagePath: "/docs/workstations/poller-run",
  overlayId: "workstation:POLLER_RUN",
  loadDefinition: () => loadWorkstationBaseSchemaEmbedModel().definition,
  loadOverlay: () => createProductionWorkstationTypeOverlay("POLLER_RUN"),
});

export const POLLER_RUN_TYPE_PAGE_PATH = embed.pagePath;
export const POLLER_RUN_TYPE_OVERLAY_ID = embed.overlayId;
export const PollerRunTypeVariantSchemaEmbed = embed.Embed;
