...
description: "A next-token rule that keeps the smallest probability mass above a threshold before drawing one token, adapting the candidate count from step to step."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.top-p-sampling" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.top-p-sampling" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.top-p-sampling" />
</Section>
