/**
 * Discoverability for migrated /docs/documentation/workstations is owned by the compatibility
...
describe("workstations documentation discoverability (compatibility)", () => {
