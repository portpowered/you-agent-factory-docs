/**
 * Discoverability for migrated /docs/documentation/dynamic-workflows is owned by the compatibility
...
describe("dynamic-workflows documentation discoverability (compatibility)", () => {
