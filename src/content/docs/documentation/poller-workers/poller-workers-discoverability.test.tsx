/**
 * Discoverability for migrated /docs/documentation/poller-workers is owned by the compatibility
...
describe("poller-workers documentation discoverability (compatibility)", () => {
