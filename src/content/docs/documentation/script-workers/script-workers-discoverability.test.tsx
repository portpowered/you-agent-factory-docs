/**
 * Discoverability for migrated /docs/documentation/script-workers is owned by the compatibility
...
describe("script-workers documentation discoverability (compatibility)", () => {
