/**
 * Discoverability for migrated /docs/documentation/inference-workers is owned by the compatibility
...
describe("inference-workers documentation discoverability (compatibility)", () => {
