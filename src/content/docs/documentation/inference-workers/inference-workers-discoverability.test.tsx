/**
 * Discoverability proof for /docs/documentation/inference-workers.
...
const DOCS_SLUG = ["documentation", "inference-workers"] as const;
const DOCS_ROUTE = "/docs/documentation/inference-workers";
const DOCS_TITLE = "Inference workers";
const DOCS_DESCRIPTION =
  "Configure you-agent-factory INFERENCE_WORKER backends for INFERENCE_RUN bounded model operations, including declared operations and provider or locality ownership.";
...
describe("inference-workers documentation discoverability", () => {
  afterEach(() => {
    cleanup();
  });
