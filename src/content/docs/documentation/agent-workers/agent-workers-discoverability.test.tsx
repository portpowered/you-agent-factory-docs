/**
 * Discoverability for migrated /docs/documentation/agent-workers is owned by the compatibility
...
describe("agent-workers documentation discoverability (compatibility)", () => {
