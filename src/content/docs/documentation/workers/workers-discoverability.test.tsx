/**
 * Discoverability for migrated /docs/documentation/workers is owned by the compatibility
...
describe("workers documentation discoverability (compatibility)", () => {
  test("resolves the §10 family target from the migration ledger", () => {
    expect(
      resolveDocumentationRouteMigrationTarget("/docs/documentation/workers"),
    ).toBe("/docs/workers");
  });
});
