...
// Spike-only CSS — keep out of app/globals.css so production export budgets
// do not pay for fumadocs-openapi styles on every page.
import "fumadocs-openapi/css/preset.css";
import "@/features/docs/styles/references-openapi-spike-theme.css";

/**
 * Heavy OpenAPI UI entry for the W01 spike. Production CI builds alias this
 * module to `spike-page-content.stub.tsx` unless ENABLE_OPENAPI_SPIKE=1 so
 * fumadocs-openapi / Scalar stay out of the static-export JS graph.
 */
