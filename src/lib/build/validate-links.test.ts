...
describe("validateDocumentationLinks", () => {
  ...
  test("collectDocumentationLinkFiles includes factory Concepts and Program documentation once", async () => {
    ...
    expect(urls).toContain("/docs/workers/mock");
    expect(urls).toContain("/docs/documentation/throttling-and-limits");
    expect(urls).toContain("/docs/workers/script");
    expect(urls).toContain("/docs/workers/poller");
    expect(urls).toContain("/docs/workers/agent");
    expect(urls).toContain("/docs/workers/inference");
    expect(urls).toContain("/docs/documentation/packaged-documents");
    expect(urls).toContain("/docs/factories/packaged");
