...
export const RETIRED_AI_CONTENT_OWNED_PATHS = [
  ...
  "src/app/(site)/(with-docs-chrome)/docs/models",
  "src/app/(site)/(with-docs-chrome)/docs/modules",
  "src/app/(site)/(with-docs-chrome)/docs/papers",
  "src/app/(site)/(with-docs-chrome)/docs/training",
  "src/app/(site)/(with-docs-chrome)/docs/systems",
  "src/app/[locale]/(with-docs-chrome)/docs/models",
  "src/app/[locale]/(with-docs-chrome)/docs/modules",
  "src/app/[locale]/(with-docs-chrome)/docs/papers",
  "src/app/[locale]/(with-docs-chrome)/docs/training",
  "src/app/[locale]/(with-docs-chrome)/docs/systems",
] as const;
