...
export function formatGeneratePageBundleUsage(): string {
  return [
    ...
    "",
    "Required:",
    "  --spec <path>  JSON page spec for concept or glossary pages",
    "",
    "Optional:",
    "  --dry-run  Print planned registry id, route, and file paths without writing files",
    "",
    "Use this as the preferred canonical page generator for concept and glossary",
    "bundles so title, summary, sections, registry fields, and assets stay",
    "aligned in one page-spec input.",
