 ...
 *
 * Prefer the docsSlug remainder after `<section>/` so nested workstations
 * (and future nested CLI) pages keep `/docs/<section>/<parent>/<child>`
 * rather than collapsing to the leaf segment alone.
 */
