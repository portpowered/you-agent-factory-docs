...
const runtimeRegistryDirectories: RuntimeRegistryDirectory[] = [
  ...
  {
    directory: "guides",
    recordType: "GuideRecord",
    schemaName: "guideRecordSchema",
    recordsConst: "guideRecords",
    mapConst: "guidesById",
  },
  {
    directory: "techniques",
    recordType: "TechniqueRecord",
    schemaName: "techniqueRecordSchema",
    recordsConst: "techniqueRecords",
    mapConst: "techniquesById",
  },
  {
    directory: "documentation",
    recordType: "DocumentationRecord",
    schemaName: "documentationRecordSchema",
    recordsConst: "documentationRecords",
