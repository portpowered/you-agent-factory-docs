...
const glossaryDefinition: DocsCollectionDefinition = {
  ...
  messageKeys: {
    browse: {
      sectionTitle: "browseIndex.conceptsSectionTitle",
      sectionDescription: "browseIndex.conceptsSectionDescription",
      sectionLinkLabel: "browseIndex.conceptsSectionLinkLabel",
    },
    index: {
      title: "conceptsIndex.title",
      description: "conceptsIndex.description",
      listLabel: "conceptsIndex.listLabel",
      emptyTitle: "conceptsIndex.emptyTitle",
      emptyDescription: "conceptsIndex.emptyDescription",
      emptyHomeLink: "conceptsIndex.emptyHomeLink",
    },
  },
