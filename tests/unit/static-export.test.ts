  ...
  test("serves the post-setup concept routes through canonical docs paths", async () => {
    const routeChecks = [
      ...
      },
      {
        ...
        nextLabel: "Logs and replays",
        nextHref: "/docs/logs-and-replays",
      },
      {
        path: "/docs/logs-and-replays",
        title: "Logs and replays",
        body: "Use replay or rerun surfaces to narrow the problem",
      ...
      },
      {
        ...
        previousLabel: "Logs and replays",
        previousHref: "/docs/logs-and-replays",
