...
~4.66 MiB search bootstrap on CI; raised again 2026-07-11 UTC after rebasing
Agent/Inference workers onto that combined main — six-page export measured
~120.83 MiB total and ~4.97 MiB search bootstrap on CI):
