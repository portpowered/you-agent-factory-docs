...
| `src/content/docs/techniques/` | CLI techniques content root; may contain authored technique page bundles (e.g. `workqueue-executor`, `classify-execute`, `ralph`, `worker-adviser`) |
