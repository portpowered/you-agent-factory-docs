...
- Served static export HTML includes generated multi-page sidebar depth, breadcrumb ancestry, and progression links on doc detail pages: `tests/unit/static-export.test.ts`
