...
| `src/app/(dev)/landing-harness/page.test.tsx` | Observable harness proofs: wired Wave A + Wave B markers + fixture content; unwired placeholder labels; absence of still-unwired fixture trees (hero title, capability labels, youi until those slots wire) |
